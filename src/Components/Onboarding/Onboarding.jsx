        ...
        <div className="flex mx-auto max-w-[1300px] h-[90vh] w-full rounded-md shadow-xl">
          ...
          <div className="left flex-1 flex items-center justify-between p-[4rem] h-full">
            <div className="flex items-start flex-col space-y-10 gap-[3rem]">
              <div>
                <h4 className="font-semibold text-[1.3rem] md:text-[2.9rem]">{title}</h4>
                <p className="text-gray-500 font-normal text-[0.9rem] md:text-[1.2rem]">{subtitle}</p>
              </div>
              {renderedOptions.map((option, index) => (
                ...
                >
                  ...
                  <div className="flex items-start gap-2 flex-col">
                    <span className="text-black text-[1.1rem] font-semibold">{option.label}</span>
          ...
          <div className="font-normal text-[.9rem] absolute top-[80%] right-[55%] flex items-center gap-2 cursor-pointer">
            Next <FaArrowRight />
          </div>
